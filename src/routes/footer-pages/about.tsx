  ...
  return (
    ...
    >
      <div className="space-y-8 text-[15.5px] leading-[1.8] text-[#2a2a2a]/85">
        ...
        <h3 className="font-display text-[22px] font-bold text-[#161616] mt-8">Matric/Stateboard and CBSE-Aligned Academic Intelligence</h3>
        <p className="mt-4 leading-[1.7]">
          Unlike generic administration software, Studiqs is custom-aligned to academic curricula. Whether your school follows the Matric/Stateboard, CBSE or custom international grading standards, our analytics and gap detection modules map directly to your curriculum's specific learning objectives and grading structures.
        </p>
        <p>
